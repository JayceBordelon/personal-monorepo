...
"[project]/components/ui/shadcn-io/typing-text/index.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const TypingText = ({ text, as: Component = "div", typingSpeed = 50, initialDelay = 0, pauseDuration = 2000, deletingSpeed = 30, loop = true, className = "", showCursor = true, hideCursorWhileTyping = false, cursorCharacter = "|", cursorClassName = "", cursorBlinkDuration = 0.5, textColors = [], variableSpeed, onSentenceComplete, startOnVisible = false, reverseMode = false, ...props })=>{
    ...
    const textArray = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TypingText.useMemo[textArray]": ()=>Array.isArray(text) ? text : [
                text
            ]
    }["TypingText.useMemo[textArray]"], [
        text
    ]);
    const getRandomSpeed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TypingText.useCallback[getRandomSpeed]": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TypingText.useEffect": ()=>{
            ...
            const observer = new IntersectionObserver({
                "TypingText.useEffect": (entries)=>{
                    entries.forEach({
                        "TypingText.useEffect": (entry)=>{
            ...
            return ({
                "TypingText.useEffect": ()=>observer.disconnect()
            })["TypingText.useEffect"];
        }
    }["TypingText.useEffect"], [
        startOnVisible
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TypingText.useEffect": ()=>{
            ...
            const executeTypingAnimation = {
                "TypingText.useEffect.executeTypingAnimation": ()=>{
                    if (isDeleting) {
                        if (displayedText === "") {
                            setIsDeleting(false);
                            ...
                            setCurrentTextIndex({
                                "TypingText.useEffect.executeTypingAnimation": (prev)=>(prev + 1) % textArray.length
                            }["TypingText.useEffect.executeTypingAnimation"]);
                            setCurrentCharIndex(0);
                            timeout = setTimeout({
                                "TypingText.useEffect.executeTypingAnimation": ()=>{}
                            }["TypingText.useEffect.executeTypingAnimation"], pauseDuration);
                        } else {
                            timeout = setTimeout({
                                "TypingText.useEffect.executeTypingAnimation": ()=>{
                                    setDisplayedText({
                                        "TypingText.useEffect.executeTypingAnimation": (prev)=>prev.slice(0, -1)
                                    }["TypingText.useEffect.executeTypingAnimation"]);
                                }
                            }["TypingText.useEffect.executeTypingAnimation"], deletingSpeed);
                        }
                    } else {
                        if (currentCharIndex < processedText.length) {
                            timeout = setTimeout({
                                "TypingText.useEffect.executeTypingAnimation": ()=>{
                                    setDisplayedText({
                                        "TypingText.useEffect.executeTypingAnimation": (prev)=>prev + processedText[currentCharIndex]
                                    }["TypingText.useEffect.executeTypingAnimation"]);
                                    setCurrentCharIndex({
                                        "TypingText.useEffect.executeTypingAnimation": (prev)=>prev + 1
                                    }["TypingText.useEffect.executeTypingAnimation"]);
                                }
                            }["TypingText.useEffect.executeTypingAnimation"], variableSpeed ? getRandomSpeed() : typingSpeed);
...
_s(TypingText, "rYuct5oxtZf9EwJat6pbcmgGcHQ=");
_c = TypingText;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tabler$2f$icons$2d$react$2f$dist$2f$esm$2f$icons$2f$IconWriting$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__IconWriting$3e$__ = __turbopack_context__.i("[project]/node_modules/@tabler/icons-react/dist/esm/icons/IconWriting.mjs [app-client] (ecmascript) <export default as IconWriting>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$shadcn$2d$io$2f$typing$2d$text$2f$index$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/shadcn-io/typing-text/index.tsx [app-client] (ecmascript)");
...
function HeroSection() {
    const socialLinks = [
        ...
        {
            icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tabler$2f$icons$2d$react$2f$dist$2f$esm$2f$icons$2f$IconWriting$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__IconWriting$3e$__["IconWriting"],
            label: "Blog",
            href: "/blog"
        }
    ];
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$shadcn$2d$io$2f$typing$2d$text$2f$index$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                text: [
                                    "Mastercard - SWE",
                                    "OccupAI - Co-Founder",
                                    "WashU - CS Alum"
...
//# sourceMappingURL=components_c54a8c0e._.js.map